 ...
 */
package com.speedycloud.auth.policy.actions;

import com.amazonaws.auth.policy.Action;
import com.amazonaws.auth.policy.Statement;
import com.speedycloud.auth.policy.resources.S3BucketResource;
import com.speedycloud.auth.policy.resources.S3ObjectResource;
...
public enum S3Actions implements Action {
     ...
     *
     * @see AmazonS3#getObject(com.speedycloud.services.s3.model.GetObjectRequest)
     * @see AmazonS3#getObjectMetadata(com.speedycloud.services.s3.model.GetObjectMetadataRequest)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#putObject(com.speedycloud.services.s3.model.PutObjectRequest)
     */
     ...
     *      com.speedycloud.services.s3.model.AccessControlList)
     * @see AmazonS3#setObjectAcl(String, String,
     *      com.speedycloud.services.s3.model.CannedAccessControlList)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#deleteObject(com.speedycloud.services.s3.model.DeleteObjectRequest)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#deleteVersion(com.speedycloud.services.s3.model.DeleteVersionRequest)
     */
     ...
     *
     * @see AmazonS3#listParts(com.speedycloud.services.s3.model.ListPartsRequest)
     */
     ...
     *
     * @see AmazonS3#abortMultipartUpload(com.speedycloud.services.s3.model.AbortMultipartUploadRequest)
     */
     ...
     *
     * @see AmazonS3#restoreObject(RestoreObjectRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#deleteBucket(com.speedycloud.services.s3.model.DeleteBucketRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#listVersions(com.speedycloud.services.s3.model.ListVersionsRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#listMultipartUploads(com.speedycloud.services.s3.model.ListMultipartUploadsRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketCrossOriginConfiguration(com.speedycloud.services.s3.model.SetBucketCrossOriginConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketVersioningConfiguration(com.speedycloud.services.s3.model.SetBucketVersioningConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#getBucketWebsiteConfiguration(com.speedycloud.services.s3.model.GetBucketWebsiteConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketWebsiteConfiguration(com.speedycloud.services.s3.model.SetBucketWebsiteConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#deleteBucketWebsiteConfiguration(com.speedycloud.services.s3.model.DeleteBucketWebsiteConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketLifecycleConfiguration(com.speedycloud.services.s3.model.SetBucketLifecycleConfigurationRequest)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.speedycloud.auth.policy.Action#getId()
     */
