...
import static com.speedycloud.services.s3.model.CryptoMode.StrictAuthenticatedEncryption;
import static com.speedycloud.services.s3.model.ExtraMaterialsDescription.NONE;
...
import com.speedycloud.services.s3.model.EncryptedGetObjectRequest;
import com.speedycloud.services.s3.model.EncryptionMaterialsProvider;
import com.speedycloud.services.s3.model.ExtraMaterialsDescription;
...
import com.speedycloud.services.s3.AmazonS3EncryptionClient;
...
class S3CryptoModuleAE extends S3CryptoModuleBase<MultipartUploadCryptoContext> {
    ...
    S3CryptoModuleAE(AWSKMS kms, S3Direct s3,
        ...
        if (mode != CryptoMode.StrictAuthenticatedEncryption
        &&  mode != CryptoMode.AuthenticatedEncryption) {
