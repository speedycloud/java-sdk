 ...
 * @see TransferManager#upload(PutObjectRequest)
 */
public interface Transfer {
     ...
     */
    @Deprecated
    public void addProgressListener(com.speedycloud.services.s3.model.ProgressListener listener);

    /**
     * @deprecated Replaced by {@link #removeProgressListener(ProgressListener)}
     */
    @Deprecated
    public void removeProgressListener(com.speedycloud.services.s3.model.ProgressListener listener);
}
