 ...
 */
package com.speedycloud.services.s3.transfer;
...
import com.speedycloud.services.s3.internal.RequestCopyUtils;
import com.speedycloud.services.s3.internal.FileLocks;
...
import com.speedycloud.services.s3.model.MultipartUpload;
...
import com.speedycloud.services.s3.transfer.Transfer.TransferState;
import com.speedycloud.services.s3.transfer.exception.FileLockException;
import com.speedycloud.services.s3.transfer.internal.CopyCallable;
import com.speedycloud.services.s3.transfer.internal.CopyImpl;
import com.speedycloud.services.s3.transfer.internal.CopyMonitor;
import com.speedycloud.services.s3.transfer.internal.DownloadImpl;
import com.speedycloud.services.s3.transfer.internal.DownloadMonitor;
import com.speedycloud.services.s3.transfer.internal.MultipleFileDownloadImpl;
import com.speedycloud.services.s3.transfer.internal.MultipleFileTransferMonitor;
import com.speedycloud.services.s3.transfer.internal.MultipleFileUploadImpl;
import com.speedycloud.services.s3.transfer.internal.S3ProgressListener;
import com.speedycloud.services.s3.transfer.internal.S3ProgressListenerChain;
import com.speedycloud.services.s3.transfer.internal.TransferManagerUtils;
import com.speedycloud.services.s3.transfer.internal.TransferProgressUpdatingListener;
import com.speedycloud.services.s3.transfer.internal.TransferStateChangeListener;
import com.speedycloud.services.s3.transfer.internal.UploadCallable;
import com.speedycloud.services.s3.transfer.internal.UploadImpl;
import com.speedycloud.services.s3.transfer.internal.UploadMonitor;
...
import static com.speedycloud.services.s3.internal.ServiceUtils.APPEND_MODE;
import static com.speedycloud.services.s3.internal.ServiceUtils.OVERWRITE_MODE;
...
public class TransferManager {
    ...
    public Download download(final GetObjectRequest getObjectRequest,
        ...
        return doDownload(getObjectRequest, file, null, null, ServiceUtils.OVERWRITE_MODE,
    ...
    public Download download(final GetObjectRequest getObjectRequest,
        ...
        return doDownload(getObjectRequest, file, null, progressListener,
                ServiceUtils.OVERWRITE_MODE, 0, null, 0L);
    }
    ...
    public Download download(final GetObjectRequest getObjectRequest,
        ...
        return doDownload(getObjectRequest, file, null, progressListener,
                ServiceUtils.OVERWRITE_MODE, timeoutMillis, null, 0L);
    }
    ...
    public Download download(final GetObjectRequest getObjectRequest,
        ...
        return doDownload(getObjectRequest, file, null, progressListener,
                ServiceUtils.OVERWRITE_MODE, timeoutMillis, null, 0L, resumeOnRetry);
    }
