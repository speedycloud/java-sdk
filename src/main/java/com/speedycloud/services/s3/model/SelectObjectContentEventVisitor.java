...
package com.speedycloud.services.s3.model;

import com.speedycloud.services.s3.model.SelectObjectContentEvent.ContinuationEvent;
import com.speedycloud.services.s3.model.SelectObjectContentEvent.EndEvent;
import com.speedycloud.services.s3.model.SelectObjectContentEvent.ProgressEvent;
import com.speedycloud.services.s3.model.SelectObjectContentEvent.StatsEvent;
import com.speedycloud.services.s3.model.SelectObjectContentEvent.RecordsEvent;
...
public abstract class SelectObjectContentEventVisitor {
    /**
     * Invoked when a {@link SelectObjectContentEvent.RecordsEvent} is encountered. If this is not overridden, the event will be given to
    ...
    /**
     * Invoked when a {@link SelectObjectContentEvent.ContinuationEvent} is encountered. If this is not overridden, the event will be given to
     * {@link #visitDefault(SelectObjectContentEvent)}.
     */
    ...
    /**
     * Invoked when a {@link SelectObjectContentEvent.ProgressEvent} is encountered. If this is not overridden, the event will be given to
     * {@link #visitDefault(SelectObjectContentEvent)}.
     */
    ...
    /**
     * Invoked when a {@link SelectObjectContentEvent.StatsEvent} is encountered. If this is not overridden, the event will be given to
     * {@link #visitDefault(SelectObjectContentEvent)}.
     */
    ...
    /**
     * Invoked when a {@link SelectObjectContentEvent.EndEvent} is encountered. If this is not overridden, the event will be given to
     * {@link #visitDefault(SelectObjectContentEvent)}.
     */
