 ...
 */
package com.speedycloud.services.s3.model.transform;
...
import com.speedycloud.services.s3.model.AccessControlTranslation;
...
import com.speedycloud.services.s3.model.BucketLifecycleConfiguration.NoncurrentVersionTransition;
import com.speedycloud.services.s3.model.BucketLifecycleConfiguration.Rule;
import com.speedycloud.services.s3.model.BucketLifecycleConfiguration.Transition;
...
import com.speedycloud.services.s3.model.CORSRule;
import com.speedycloud.services.s3.model.CORSRule.AllowedMethods;
import com.speedycloud.services.s3.model.CloudFunctionConfiguration;
import com.speedycloud.services.s3.model.Filter;
import com.speedycloud.services.s3.model.FilterRule;
import com.speedycloud.services.s3.model.LambdaConfiguration;
import com.speedycloud.services.s3.model.NotificationConfiguration;
import com.speedycloud.services.s3.model.QueueConfiguration;
import com.speedycloud.services.s3.model.RedirectRule;
import com.speedycloud.services.s3.model.ReplicationDestinationConfig;
import com.speedycloud.services.s3.model.ReplicationRule;
import com.speedycloud.services.s3.model.RoutingRule;
import com.speedycloud.services.s3.model.RoutingRuleCondition;
import com.speedycloud.services.s3.model.S3KeyFilter;
import com.speedycloud.services.s3.model.ServerSideEncryptionByDefault;
import com.speedycloud.services.s3.model.ServerSideEncryptionConfiguration;
import com.speedycloud.services.s3.model.ServerSideEncryptionRule;
import com.speedycloud.services.s3.model.SseKmsEncryptedObjects;
import com.speedycloud.services.s3.model.Tag;
import com.speedycloud.services.s3.model.TagSet;
import com.speedycloud.services.s3.model.TopicConfiguration;
import com.speedycloud.services.s3.model.analytics.AnalyticsAndOperator;
import com.speedycloud.services.s3.model.analytics.AnalyticsConfiguration;
import com.speedycloud.services.s3.model.analytics.AnalyticsExportDestination;
import com.speedycloud.services.s3.model.analytics.AnalyticsFilter;
import com.speedycloud.services.s3.model.analytics.AnalyticsFilterPredicate;
import com.speedycloud.services.s3.model.analytics.AnalyticsPredicateVisitor;
import com.speedycloud.services.s3.model.analytics.AnalyticsPrefixPredicate;
import com.speedycloud.services.s3.model.analytics.AnalyticsS3BucketDestination;
import com.speedycloud.services.s3.model.analytics.AnalyticsTagPredicate;
import com.speedycloud.services.s3.model.analytics.StorageClassAnalysis;
import com.speedycloud.services.s3.model.analytics.StorageClassAnalysisDataExport;
import com.speedycloud.services.s3.model.inventory.InventoryConfiguration;
import com.speedycloud.services.s3.model.inventory.InventoryDestination;
import com.speedycloud.services.s3.model.inventory.InventoryEncryption;
import com.speedycloud.services.s3.model.inventory.InventoryFilter;
import com.speedycloud.services.s3.model.inventory.InventoryFilterPredicate;
import com.speedycloud.services.s3.model.inventory.InventoryPrefixPredicate;
import com.speedycloud.services.s3.model.inventory.InventoryS3BucketDestination;
import com.speedycloud.services.s3.model.inventory.InventorySchedule;
import com.speedycloud.services.s3.model.inventory.ServerSideEncryptionKMS;
import com.speedycloud.services.s3.model.inventory.ServerSideEncryptionS3;
import com.speedycloud.services.s3.model.lifecycle.LifecycleAndOperator;
import com.speedycloud.services.s3.model.lifecycle.LifecycleFilter;
import com.speedycloud.services.s3.model.lifecycle.LifecycleFilterPredicate;
import com.speedycloud.services.s3.model.lifecycle.LifecyclePredicateVisitor;
import com.speedycloud.services.s3.model.lifecycle.LifecyclePrefixPredicate;
import com.speedycloud.services.s3.model.lifecycle.LifecycleTagPredicate;
import com.speedycloud.services.s3.model.metrics.MetricsAndOperator;
import com.speedycloud.services.s3.model.metrics.MetricsConfiguration;
import com.speedycloud.services.s3.model.metrics.MetricsFilter;
import com.speedycloud.services.s3.model.metrics.MetricsFilterPredicate;
import com.speedycloud.services.s3.model.metrics.MetricsPredicateVisitor;
import com.speedycloud.services.s3.model.metrics.MetricsPrefixPredicate;
import com.speedycloud.services.s3.model.metrics.MetricsTagPredicate;
import com.amazonaws.util.CollectionUtils;
import com.speedycloud.services.s3.internal.Constants;
import com.speedycloud.services.s3.internal.ServiceUtils;
import com.speedycloud.services.s3.internal.XmlWriter;
import com.speedycloud.services.s3.model.*;
import com.speedycloud.services.s3.model.analytics.*;
import com.speedycloud.services.s3.model.inventory.*;
import com.speedycloud.services.s3.model.lifecycle.*;
import com.speedycloud.services.s3.model.metrics.*;
...
public class BucketConfigurationXmlFactory {
    ...
    */
    ...
    /**
     * Converts the specified {@link com.speedycloud.services.s3.model.analytics.AnalyticsConfiguration} object to an
     * XML fragment that can be sent to Amazon S3.
     *
     * @param config
     *            The {@link com.speedycloud.services.s3.model.analytics.AnalyticsConfiguration}
     */
     /*
    ...
    /**
     * Converts the specified {@link MetricsConfiguration}
     * object to an XML fragment that can be sent to Amazon S3.
     *
     * @param config
     *            The {@link MetricsConfiguration}.
     */
     /*
